...
def get_job_listings(start_page: int = 1, display: int = 10) -> Tuple[Optional[pd.DataFrame], str]:
    base_url = "https://www.work24.go.kr/cm/openApi/call/wk/callOpenApiSvcInfo210L01.do?authKey=[b2f7660c-9fd4-4525-9d2e-6cd14440ec35]&callTp=L&returnType=XML&startPage=1&display=10"
